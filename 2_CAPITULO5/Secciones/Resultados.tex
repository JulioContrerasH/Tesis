...
\chapter{RESULTADOS}
    ...
    \section{Análisis Estadístico de los Resultados}
        ...
        %     La aplicación de métricas de rendimiento avanzadas como CLIPScore ofreció una perspectiva adicional sobre la calidad de las imágenes generadas. Se obtuvo un CLIPScore promedio de 0.82, superando las métricas obtenidas con métodos previos, lo que refleja una mayor coherencia visual y semántica con las imágenes TM originales.
