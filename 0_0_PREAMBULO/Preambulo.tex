...
% -------------------------------------
% Información Personal y del Trabajo
% -------------------------------------
\author{Nombre1 Nombre2 Apellido1 Apellido2} % Autor para el pie de página
\authorcaratula{NOMBRE1 NOMBRE2 APELLIDO1 APELLIDO2} % Autor para la carátula (mayúsculas)
\title{Xxxxxxxxxxx Título de la Tesis Xxxxxxxxxxx} % Título para el pie de página
\titlecaratula{XXXXXXXXXXXX TÍTULO DE LA TESIS XXXXXXXXXXXXXX} % Título para la carátula (mayúsculas)
\facultad{FACULTAD DE INGENIERÍA CIVIL} % Nombre de la facultad (mayúsculas)
\grado{INGENIERO CIVIL} % Título profesional (mayúsculas)
\asesor{DR. NOMBRE DEL ASESOR} % Asesor para la carátula (mayúsculas)
\yyearr{2024} % Año para la carátula
