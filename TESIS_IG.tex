...
\geometry{
  left=3.2cm,    % Margen izquierdo
  right=3.2cm,   % Margen derecho
...
\begin{document}
	...
	% \include{2_CAPITULO2/MarcoTeorico.tex}
	% \include{2_CAPITULO3/HipotesisVariables.tex}
	% \include{2_CAPITULO4/MaterialesMetodos.tex}
	% \include{2_CAPITULO5/Secciones/Resultados.tex}
	% \include{2_CAPITULO5/Secciones/Discusion.tex}
	% \include{2_CAPITULO5/Secciones/ConclusionesRecomendaciones.tex}
	...
	\input{3_3_BIBLIOGRAFIA/Bibliografia.tex}
