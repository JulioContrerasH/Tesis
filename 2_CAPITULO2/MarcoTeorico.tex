        ...
        \subsection{Armonización de imágenes satelitales}
            \subsubsection{Landsat: satélites de observación terrestre}
                ...
                \paragraph{Landsat MSS}
                    ...
                    \subparagraph{Landsat 1 (ERTS-1) y su MSS.}
                        ...
                        \begin{figure}[H] 
                            ...
                            \begin{justify}
                                \textit{Nota.} Imagen sin nubes del sistema MSS de Landsat 1 mostrando las Montañas Ouachita en el sureste de Oklahoma.
                            \end{justify}                    
                            \label{landsat1}
                        \end{figure}
    

                    \subparagraph{Landsat 2.}
                        ...
                        \begin{figure}[H] 
                            ...
                            \begin{justify}
                                \textit{Nota.} Comparación de las escenas MSS archivadas de Landsat 1 y 2 en 1975, mostrando la cantidad y distribución de datos recopilados.
                            \end{justify}                    
                            \label{landsat2}
                        \end{figure}

                    \subparagraph{Landsat 3.}
                        ...
                        \begin{figure}[H] 
                            ...
                            \begin{justify}
                                \textit{Nota.} Imagen que muestra los problemas de inicio de línea del MSS de Landsat 3 en comparación con una imagen MSS de Landsat 2.
                            \end{justify}                    
                            \label{landsat3}
                        \end{figure}

                    \subparagraph{Landsat 4.}
                        ...
                        \begin{figure}[H] 
                            ...
                            \begin{justify}
                                \textit{Nota.} Mapas de cobertura anual del MSS de Landsat 4, mostrando la cobertura geográfica durante su operación.
                            \end{justify}                    
                            \label{landsat4}
                        \end{figure}

                    \subparagraph{Landsat 5.}
                        ...
                        \begin{figure}[H] 
                            ...
                            \centering
                            \includegraphics[width=1\linewidth]{2_CAPITULO2/IMG/landsat5.png}
                            \begin{justify}
                                \textit{Nota.} Mapas de cobertura anual del MSS de Landsat 5, mostrando la cobertura geográfica durante su operación.
                            \end{justify}                    
                            \label{landsat5}
                        \end{figure}

                    \subparagraph{Fechas del Landsat MSS.}
                ...
                \paragraph{Landsat TM}
                    ...
                    \subparagraph{Landsat 4.}
                        ...
                        \begin{figure}[H] 
                            ...
                            \begin{justify}
                                \textit{Nota.} Se muestra un área alrededor de la frontera California/Oregón, incluyendo Goose Lake, Clear Lake National Refuge, Lava Beds National Monument y Modoc National Forest (TM Bandas 7, 4, 2​).
                            \end{justify}                    
                            \label{landsat4_tm}
                        \end{figure}
                    ...
                    \subparagraph{Landsat 5.}
                        ...
                        \begin{figure}[H] 
                            ...
                            \begin{justify}
                                \textit{Nota.} Se muestra Duluth, Minnesota y el rompimiento del hielo en el Lago Superior, adquirida el 6 de marzo de 1984​.
                            \end{justify}                    
                            \label{landsat5_tm}
                        \end{figure}
