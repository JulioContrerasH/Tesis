...
\chapter{INTRODUCCIÓN}
    ...
    \section{Planteamiento del problema}
        ...
        \subsection{Formulación del problema}
            ...
            \begin{itemize}
                \item[-] ¿Cómo puede la inteligencia artificial armonizar las imágenes Landsat MSS para su uso en el monitoreo global y a largo plazo?
            \end{itemize}
        ...
        \subsection{Objetivo General}
            ...
            \subsection{Objetivos Específicos}
                \begin{itemize}
                    ...
                    \item[-] Implementar una técnica de aprendizaje profundo para generar bandas faltantes en imágenes MSS que existen en las TM.
                \end{itemize}
    ...
    \section{Limitaciones de la investigación}
        \begin{itemize}
            \item[-] La investigación se limita a la armonización de imágenes Landsat MSS y TM, sin considerar otros sensores satelitales.
            \item[-] La investigación se limita a la armonización de imágenes Landsat MSS y TM, sin considerar otros sensores satelitales.
            \item[-] La investigación se limita a la armonización de imágenes Landsat MSS y TM, sin considerar otros sensores satelitales.
        \end{itemize}
