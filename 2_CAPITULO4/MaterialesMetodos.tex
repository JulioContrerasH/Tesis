...
\chapter{METODOLOGÍA}
    ...
    \section{Población y muestra}
        ...
        \subsection{Muestra}
            ...
            Para la implementación de la superresolución MSS a TM mediante el modelo GAN, se implementaron técnicas de clasificación supervisada, que requieren un conjunto de datos dividido en muestras de entrenamiento y validación.
